# SinoPac Genie - 自選股排版與排序優化任務清單 (v1.3.21)
...
- [x] 3. 版本號升級 (v1.3.21) 與文件更新
  - [x] 更新 [index.html](file:///d:/AntigravityProjects/SinoPac_API/web/index.html) 頁尾版號與 CSS/JS 快取尾綴至 `v1.3.21`
