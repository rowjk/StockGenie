...
const DEMO_KNOWN_TW = {
    // 指數 / 大盤
    '001': { name: '加權指數', price: 45696.47 },
    'TSE001': { name: '加權指數', price: 45696.47 },
    'OTC101': { name: '櫃買指數', price: 260.0 },
    'TXFR1': { name: '台指期近月', price: 45829.00 },
    'MXFR1': { name: '小台指近月', price: 45829.00 },
    ...
    // 熱門 ETF / 槓桿型
    '0050': { name: '元大台灣50', price: 106.35 },
    '0056': { name: '元大高股息', price: 52.80 },
    ...
    '00631L': { name: '元大台灣50正2', price: 37.22 },
    '00632R': { name: '元大台灣50反1', price: 10.14 },
